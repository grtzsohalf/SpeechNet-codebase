...
class OnlinePreprocessor(torch.nn.Module):
    def __init__(self, sample_rate=16000, win_ms=25, hop_ms=10, n_freq=1025, n_mels=40, n_mfcc=13, feat_list=None, eps=1e-10, **kwargs):
        ...
        self._istft_args = copy.deepcopy(self._stft_args)
        self._istft_args.pop('pad_mode')
        ...
        self._istft = partial(torch.istft, **self._win_args, **self._istft_args)
