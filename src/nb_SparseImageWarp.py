...
def apply_interpolation(query_points, train_points, w, v, order):
    ...
    # print('multi. with w[0]: ', torch.matmul(phi_pairwise_dists, w[:, :, 0]))
    # print('multi. with w[1]: ', torch.matmul(phi_pairwise_dists, w[:, :, 1]))
    # print('rbf: ', phi_pairwise_dists, w, rbf_term)
...
def interpolate_bilinear(grid,
    ...
    for dim in index_order:
        ...
        alpha = (queries - floor).clone().detach().type(grid_type).to(grid_device)
